...
function mnist.loadTrainSet(maxLoad, numClasses)
   return mnist.loadDataset(mnist.path_trainset, maxLoad, numClasses)
end

function mnist.loadTestSet(maxLoad, numClasses)
   return mnist.loadDataset(mnist.path_testset, maxLoad, numClasses)
end

function mnist.loadDataset(fileName, maxLoad,numClasses)
   mnist.download()
